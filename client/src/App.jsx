...
import Mode from "./components/mode/Mode"; // Import Mode component
...
const App = () => {
  ...
  const [darkMode, setDarkMode] = useState(localStorage.getItem("darkMode") === "true");//chnage
  ...
  return (
    <documentsContext.Provider value={{ documents, setDocuments, getFiles }}>
      <section className={user ? "main-grid" : null}>
        <Mode changeColorMode={changeColorMode} darkMode={darkMode} />
        {user && (
          <div>
            <Menu
